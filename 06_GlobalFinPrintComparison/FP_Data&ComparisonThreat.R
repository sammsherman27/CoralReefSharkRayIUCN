###### FinPrint to IUCN #######
setwd("/Users/samanthasherman/Dropbox/Global Shark Trends Red Listing/General Communications/Manuscripts/a_CoralReef/FinPrintComparison")
...
### Needs values that are not zero or one so
